...
public class PostgresDataBaseJdbc implements DataBaseService, Serializable {
    @Inject
    @DecoratorQualifier
    LoggerInterface loggerService;

    private Connection getConnection(){
        String url = "jdbc:postgresql://postgresDB:5432/lab3db";
    ...
    public void createPoint(Point point) {
        ...
        loggerService.logInfo(String.format("%s added to PostgreSQL (JDBC)", point));
    }
    @Override
    public ArrayList<Point> getPoints() {
        ...
        loggerService.logInfo("Fetched points from PostgreSQL (JDBC)");
        return points;
    }
}
